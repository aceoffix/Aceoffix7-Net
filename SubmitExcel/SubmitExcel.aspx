<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubmitExcel.aspx.cs" Inherits="Aceoffix7_Net.SubmitExcel.SubmitExcel" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function SaveData() {
            aceoffixctrl.SaveDataPage = "/SubmitExcel/SaveData.aspx";
