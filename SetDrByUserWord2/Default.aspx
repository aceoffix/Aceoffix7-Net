<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Aceoffix7_Net.SetDrByUserWord2.Default" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function OpenFile() {
            ...
            AceBrowser.openWindow('Word.aspx?userName=' + userName, 'width=1200px;height=900px;');
        }
    </script>
</head>
<body>
