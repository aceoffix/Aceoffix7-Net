<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Word.aspx.cs" Inherits="Aceoffix7_Net.SetDrByUserWord2.Word" %>
...
<head>
    ...
    <script type="text/javascript">
        function Save() {
            aceoffixctrl.SaveDataPage = "/SetDrByUserWord2/SaveData.aspx?userName=<%=userName%>";
