<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Aceoffix7_Net.FileMakerConvertPDFs.Default" %>
 ...
 <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function ConvertFile(idArr, index) {
            ...
            var saveFileUrl = "/FileMakerConvertPDFs/SaveMaker.aspx";
            var openFileUrl = "/FileMakerConvertPDFs/Convert.aspx";
            ...
            filemakerctrl.CallFileMaker({
                ...
                success: function (res) {
                    ...
                    console.log(res);//res：The custom saving result returned by the server side
                    setProgress1(100);
   ...
   <div style="margin:100px" align="center">
	...
	<div style="width:600px;margin: 0 auto; font-size:14px;">
		<p style="text-align: left;">
			Instructions:<br/>
			1. Check the files below;<br/>
			2. Click on the "Batch Convert PDF Documents" button;<br/>
			3. After generation is complete, you can find the batch-generated PDF files in the "FileMakerConvertPDFs/doc" directory.<br/>
		</p>
	</div>
	<table id="table1" >
		<h3>File List</h3>
		<tr >
			<th><input name="checkAll" type="checkbox" onclick="selectall()"/></th>
			<th>Serial Number</th>
			<th>Filename</th>
			<th>Action</th>
		</tr>
		<tr>
			...
			<td><a href="javascript:AceBrowser.openWindow('Edit.aspx?id=1','width=1150px;height=800px;');">Edit</a></td>
		</tr>
		<tr>
			<td><input name="check" type="checkbox" value="2"/></td>
			<td>02</td>
			<td>Aceoffix Trial Limits</td>
			<td><a href="javascript:AceBrowser.openWindow('Edit.aspx?id=2','width=1150px;height=800px;');">Edit</a></td>
		</tr>
		<tr>
			<td><input name="check" type="checkbox" value="3"/></td>
			<td>03</td>
			<td>Aceoffix License Policy</td>
			<td><a href="javascript:AceBrowser.openWindow('Edit.aspx?id=3','width=1150px;height=800px;');">Edit</a></td>
		</tr>
		<tr>
			<td><input name="check" type="checkbox" value="4"/></td>
			<td>04</td>
			<td>Introduction to Aceoffix</td>
			<td><a href="javascript:AceBrowser.openWindow('Edit.aspx?id=4','width=1150px;height=800px;');">Edit</a></td>
		</tr>
	</table>

	<input type="button" id="Button1" value="Batch Convert PDF Documents" onclick="ConvertFiles()"/>
