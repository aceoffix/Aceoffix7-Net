<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Word.aspx.cs" Inherits="Aceoffix7_Net.SaveDataAndFile.Word" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Save() {
            var saveUrl = "/SaveDataAndFile/SaveFile.aspx";
            var saveDataUrl = "/SaveDataAndFile/SaveData.aspx";
