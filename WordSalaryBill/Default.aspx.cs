    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (reader.Read())
            {
                ...
                strHtml.Append("<td style='text-align:center;'><a href='javascript:AceBrowser.openWindow(\"View.aspx?ID=" + pID + "\", \"width=1200px;height=800px;\");'>View</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:AceBrowser.openWindow(\"Edit.aspx?ID=" + pID + "\", \"width=1200px;height=800px;\"," + pID + ");'>Edit</a></td>");
                strHtml.Append("</tr>");
            }
