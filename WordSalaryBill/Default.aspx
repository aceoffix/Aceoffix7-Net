<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Aceoffix7_Net.WordSalaryBill.Default" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        // Function to get the IDs of selected records and open the Compose.aspx page
        function getID() {
            var ids = "";
            for (var i = 1; i < 11; i++) {
            ...
            if (ids == "") {
               ...
               AceBrowser.openWindow('Compose.aspx?ids=' + ids.substr(0, ids.length - 1), 'width=1200px;height=800px;');
            }
        }
    </script>
</head>
