<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendParameters.aspx.cs" Inherits="Aceoffix7_Net.SendParameters.SendParameters" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Save() {
            ...
            var saveUrl = "/SendParameters/SaveFile.aspx";
