<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WordToPDF.aspx.cs" Inherits="Aceoffix7_Net.SaveAsPDF.WordToPDF" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        // Save the file
        function Save() {
            aceoffixctrl.SaveFilePage = "/SaveAsPDF/SaveFile.aspx";
