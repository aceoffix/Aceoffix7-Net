        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["id"] != null && Request.QueryString["id"].Length > 0)
            {
                ...
                else
                {
                    ...
                    Response.Write("<script>alert('No file information obtained!');location.href='Default.aspx'</script>");
                }
            ...
            {
                Response.Write("<script>alert('File ID not obtained!');location.href='Default.aspx'</script>");
            }
        }
    }
}