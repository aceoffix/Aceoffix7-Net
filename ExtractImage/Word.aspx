<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Word.aspx.cs" Inherits="Aceoffix7_Net.ExtractImage.Word" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Save() {
            aceoffixctrl.SaveDataPage = "/ExtractImage/SaveData.aspx";
