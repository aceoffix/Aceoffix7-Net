<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Word.aspx.cs" Inherits="Aceoffix7_Net.BeforeAndAfterSave.Word" %>
...
<body>
    <script type="text/javascript">
        ...
        function Save() {
            ...
            aceoffixctrl.SaveFilePage = "/BeforeAndAfterSave/SaveFile.aspx";
