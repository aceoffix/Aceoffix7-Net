<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaveReturnValue.aspx.cs" Inherits="Aceoffix7_Net.SaveReturnValue.SaveReturnValue" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Save() {
            var saveUrl = "/SaveReturnValue/SaveFile.aspx";
...
<body>
    ...
    <div style=" font-size:small; color:Red;">
        ...
        <br/>aceoffixctrl.CustomSaveResult // Get the return value defined by the background code fs.CustomSaveResult = "OK"; in the save page SaveFile.aspx.cs
        <br />
    </div>
