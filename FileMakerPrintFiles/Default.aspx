<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Aceoffix7_Net.FileMakerPrintFiles.Default" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConvertFile(idArr, index) {
            ...
            var openFileUrl = "/FileMakerPrintFiles/FileMaker.aspx";
    ...
    <div style="margin: 100px" align="center">
        ...
        <table id="table1">
            ...
            <tr>
                ...
                <td><a href="javascript:AceBrowser.openWindow('Preview.aspx?id=1','width=1150px;height=800px;');">Preview</a></td>
            </tr>
            <tr>
                <td>
                ...
                <td><a href="javascript:AceBrowser.openWindow('Preview.aspx?id=2','width=1150px;height=800px;');">Preview</a></td>
            </tr>
            <tr>
                <td>
                ...
                <td><a href="javascript:AceBrowser.openWindow('Preview.aspx?id=3','width=1150px;height=800px;');">Preview</a></td>
            </tr>
            <tr>
                <td>
                ...
                <td><a href="javascript:AceBrowser.openWindow('Preview.aspx?id=4','width=1150px;height=800px;');">Preview</a></td>
            </tr>
        </table>
