<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Excel.aspx.cs" Inherits="Aceoffix7_Net.SimpleExcel.Excel" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>SimpleExcel</title>
</head>
<body>
    <script type="text/javascript">
        function SaveDoc() {
            aceoffixctrl.SaveFilePage = "/SimpleExcel/SaveFile.aspx";
