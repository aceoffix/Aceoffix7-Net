<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Aceoffix7_Net.ConcurrencyCtrl.Default" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function editFile(id) {
                ...
                $.ajax({
                    url: 'detectCurrentEditor.aspx?id=' + id,
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        if (data.editor == user || data.editor == '') {
                            AceBrowser.openWindow('Word.aspx?id=' + id + '&user=' + user, 'width=1200px;height=800px;');
                        } else {
            ...
            function viewFile(id) {
                var user = $('#slt_user').val();
                AceBrowser.openWindow('Word2.aspx?id=' + id + '&user=' + user, 'width=1200px;height=800px;');
            }
