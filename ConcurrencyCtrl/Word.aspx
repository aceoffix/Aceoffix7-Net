<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Word.aspx.cs" Inherits="Aceoffix7_Net.ConcurrencyCtrl.Word" %>
...
<head runat="server">
	...
	<script type="text/javascript">
        ...
        function Save() {
            var saveUrl = "/ConcurrencyCtrl/SaveFile.aspx";
        ...
        function SendCloseMsg() {
            $.ajax({
                url: 'clearCurrentEditor.aspx?id=<%=id%>',
                type: 'GET',
                dataType: 'json',
